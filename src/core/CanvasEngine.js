define(
    ...
    function(
        ...
        CanvasEngine.prototype = Object.create(AppObject.prototype);
        CanvasEngine.prototype.constructor = CanvasEngine;
        ...
        /*
         CanvasEngine: removeLayer(int zIndex | CanvasLayer)
         Remove uma camada de canvas pelo zIndex
         */
        CanvasEngine.prototype.removeLayer = function(layer){
            var self = this;
